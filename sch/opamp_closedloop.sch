...
C {devices/vsource.sym} 600 -200 0 0 {name=V1 value=DC\{vss\}}
C {devices/vsource.sym} 700 -200 0 0 {name=V2 value=DC\{vdd\}}
C {devices/gnd.sym} 600 -130 0 0 {name=l14 lab=GND}
C {devices/vsource.sym} 800 -200 0 0 {name=V4 value="sin(0 \{vac\} 1Meg) dc 0 ac 1"}
C {devices/capa.sym} 800 -300 2 0 {name=C4
m=1
value=1
footprint=1206
device="ceramic capacitor"}
C {devices/lab_pin.sym} 700 -270 1 0 {name=l15 sig_type=std_logic lab=vdd}
C {devices/lab_pin.sym} 600 -270 1 0 {name=l16 sig_type=std_logic lab=vss}
C {devices/lab_pin.sym} 700 -130 3 0 {name=l18 sig_type=std_logic lab=vss}
C {devices/lab_pin.sym} 800 -130 3 0 {name=l20 sig_type=std_logic lab=vcm}
C {devices/isource.sym} 1210 -220 0 0 {name=I0 value=DC\{iref\}}
C {devices/lab_pin.sym} 1210 -150 3 0 {name=l22 sig_type=std_logic lab=vss}
C {devices/lab_wire.sym} 800 -250 3 0 {name=l24 sig_type=std_logic lab=vsen}
C {devices/res.sym} 890 -360 1 0 {name=R1
value=500
footprint=1206
device=resistor
m=1}
...
device=resistor
m=1}
C {devices/lab_pin.sym} 1030 -210 3 0 {name=l28 sig_type=std_logic lab=vss
}
C {devices/capa.sym} 1030 -280 0 0 {name=C5
m=1
value=5p
footprint=1206
device="ceramic capacitor"}
...
.control
  ...
  *write ~/caravel_fulgor_opamp/xschem/sim_results/opamp_closeloop_ac1.raw
  write ~/Desktop/EDA/TIA_IPN/sch/sim_results/opamp_closedloop_ac1.raw
...
C {devices/lab_wire.sym} 1360 -340 0 0 {name=l3 sig_type=std_logic lab=vout}
C {devices/lab_pin.sym} 1110 -150 3 0 {name=l5 sig_type=std_logic lab=vss}
C {devices/lab_wire.sym} 1150 -320 0 0 {name=l4 sig_type=std_logic lab=vcm}
C {devices/vsource.sym} 1110 -220 0 0 {name=V5 value=DC\{vcm\}}
C {devices/lab_wire.sym} 1110 -360 0 0 {name=l6 sig_type=std_logic lab=vin}
C {devices/lab_wire.sym} 840 -360 0 0 {name=l7 sig_type=std_logic lab=vin_signal}
